...
/**
 * @author liuyoubin
 * @since 2020/1/28 - 12:06
 */
public class UploadVideoDemo {
    //账号AK信息请填写(必选)
    private static final String accessKeyId = "LTAI4FmESLjiaK3biNzErbTt";
    //账号AK信息请填写(必选)
    private static final String accessKeySecret = "7XDybr1OK8FaDeyf1xfep00aVuoER0";
    public static void main(String[] args) {
        ...
        //文件名必须包含扩展名
        String fileName = "F:\\项目资源\\课程中心微服务项目\\06.资源\\课程视频\\2 - Projects and Progress.mp4";
        //本地文件上传
